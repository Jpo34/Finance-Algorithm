...
def main():
    ...
    st.write("Scan S&P 500 stocks for bullish technical setups.")
    ...
    with st.sidebar:
        ...
        selected_tickers = st.multiselect(
            ...
            options=tickers,
            default=[],
            help="Choose one or more tickers, or leave empty to scan all S&P 500."
        )
    ...
    if run_scan:
        ...
        if results:
            ...
            st.download_button("Download CSV", csv, "sp500_scan_output.csv", "text/csv")
        else:
